              ...
              <div className="space-y-8">
                <div className={`p-8 rounded-2xl transition-all duration-300 ${
                  ...
                  <p className={`text-lg leading-relaxed ${
                    ...
                    I'm a creative professional with over 5 years of experience in design and development. 
                    I specialize in creating user-centered digital solutions that combine beautiful aesthetics 
                ...
                <div className={`p-8 rounded-2xl transition-all duration-300 ${
                  ...
                  <p className={`text-lg leading-relaxed ${
                    ...
                    Every project starts with understanding the user's needs and ends with 
              ...
              <div className="space-y-8">
                <div className={`p-8 rounded-2xl transition-all duration-300 ${
                  ...
                  <div className="space-y-3">
                    {['UI/UX Design', 'Frontend Development', 'React & Next.js', 'TypeScript', 'Tailwind CSS', 'Figma & Adobe Creative Suite'].map((skill, index) => (
